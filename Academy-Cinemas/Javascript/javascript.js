...
//Shrinks header size when the document is scrolled down by se pixels
$(document).on("scroll", function () {
    //When the webpage is scrolled down from the top by 50px this
    //if statement will trigger
    if ($(document).scrollTop() > 50) {
        //Once the Sepx requirment has been met add the
...
//Close mobile meno when a navigation link is clicked
